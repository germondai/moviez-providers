...
Because these scrapers are getting harder and harder to maintain, as they get patched. We need to close-source them. This is unfortunate, but it's the reality of the pirating scene. Sites that we scrape are blocking us, and we keep losing them. Fortunately, moviez has partnered with many people who offered their services on the site.
...
package that holds all providers of moviez.
