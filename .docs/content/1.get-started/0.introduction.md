...
## What is `@moviez/providers`?

`@moviez/providers` is the soul of [moviez](https://github.com/moviez/moviez). It's a collection of scrapers of various streaming sites. It extracts the raw streams from those sites, so you can watch them without any extra fluff from the original sites.
